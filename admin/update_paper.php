...
<section class="pdf-form">
   ...
   <form action="" method="post" enctype="multipart/form-data">
      ...
      <embed src="uploaded_files/papers/<?= urlencode($fetch_paper['pdf']); ?>" type="application/pdf" scrolling="auto" style="width:100%; height:500px;" frameborder="0"></embed>
      <p>update Paper</p>
      <input type="file" name="pdf" accept="pdf/*" class="box">
      <input type="submit" value="update paper" name="update" class="btn">
      <div class="flex-btn">
         <a href="view_paper.php?get_id=<?= $pdf_id; ?>" class="option-btn">view Paper</a>
   ...
   <?php
         ...
         echo '<p class="empty">The paper not found! <a href="add_paper.php" class="btn" style="margin-top: 1.5rem;">add paper</a></p>';
      }
   ?>
